class CronParser
  ...
  def minute
    SubExpression.new(sub_expression_string: sub_expressions.minute,
  ...
  def hour
    SubExpression.new(sub_expression_string: sub_expressions.hour,
  ...
  def day_of_month
    SubExpression.new(sub_expression_string: sub_expressions.day_of_month,
  ...
  def month
    SubExpression.new(sub_expression_string: normalized_month,
  ...
  def day_of_week
    SubExpression.new(sub_expression_string: normalized_day_of_week,
